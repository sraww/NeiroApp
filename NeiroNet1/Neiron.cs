   ...
   // это класс нейрона, каждый нейрон хранит в себе массив определённого образа может обучаться и сравнивать значение с имеющимся в памяти
    public class Neiron
    {
        ...
        // очистить память нейрона и присвоить ему новое имя
         ...
         // функция возвращает сумму величин отклонения входного массива от эталонногочем результат ближе к 1 тем больше похож входной массив  на образ из памяти нейрона
